  ...
  <div id="account">
    ...
    <div class="adminPanel" v-else>
      <ul class="left">
        ...
        <router-link active-class="act" tag="li" to="/Account/view">概览</router-link>
        <router-link active-class="act" tag="li" to="/Account/blog">博客</router-link>
...
export default {
  ...
  methods: {
    jump () {
      ...
      axios.post('/api/account/check', JSON.stringify(user), {
        headers: {
...
#account{
  ...
  .loginPanel{
    ...
    box-shadow: 0 0 100px rgba($color: #fff, $alpha: .3);
    margin: 200px auto;
    padding: 20px;
